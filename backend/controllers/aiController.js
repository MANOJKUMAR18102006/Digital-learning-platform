...
export const chat = async (req, res, next) => {
    try {
        ...
        chatHistory.messages.push(
            ...
            { role: 'assistant', content: answer, timestamp: new Date(), relevantChunks: chunkIndexes }
        );
...
export const getChatHistory = async (req, res, next) => {
    try {
        ...
        if (!chatHistory) {
            return res.status(200).json({ success: true, data: [], message: 'No chat history found for this document' });
        }
